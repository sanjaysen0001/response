...
const Manageconfidential = () => {
    return (
      ...
      <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
        ...
        <table class="table">
  <thead>
    <tr style={{backgroundColor:'rgb(43, 77, 129)',width:'100%',color:'white',textAlign:'center'}}>
      <th scope="col" style={{borderRight:'2px solid white'}}>Item</th>
      <th scope="col" style={{borderRight:'2px solid white'}}>Nominee Name</th>
      <th scope="col" style={{borderRight:'2px solid white'}}>Relation with Nominee</th>
      <th scope="col" style={{borderRight:'2px solid white'}}>Action</th>
    </tr>
  </thead>
  <tbody>
    <tr style={{backgroundColor:'rgb(176, 193, 219)',width:'100%',textAlign:'center',fontSize:'18px',color:'black'}}>
      <td scope="row" style={{borderRight:'2px solid white',color:'black'}}>Confidential Note</td>
    ...
    <span className="icon-name" style={{marginLeft:'1.2%',marginTop:'-5px',padding:'5px'}}>View</span>
      </span>
   ...
   <span className="icon-name" style={{marginLeft:'1.2%',marginTop:'-5px',padding:'5px'}}>Edit</span>
      </span>
      <span className='ml-1 btn icon-container'>
